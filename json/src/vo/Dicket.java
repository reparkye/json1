...
public class Dicket {
	...
	public Dicket(Integer tmnum, String tmname, Integer tmprice, String tmstartdat, String tmenddat,
	...
	public String toString() {
		return "DicketInfo [tmnum=" + tmnum + ", tmname=" + tmname + ", tmprice=" + tmprice + ", tmstartdat="
